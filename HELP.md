...
* The original package name 'com.compra.spring-boot-microservice-compra' is invalid and this project uses 'com.compra.spring_boot_microservice_compra' instead.
